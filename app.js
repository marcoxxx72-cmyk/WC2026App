      ...
      tab===8?e('div',{style:{paddingBottom:16}},
        ...
        e('div',{style:{position:'relative',width:'100%',maxWidth:300,margin:'0 auto 12px',height:140,background:'linear-gradient(180deg,#1a4a1a,#2d7a2d)',borderRadius:10,overflow:'visible',border:'2px solid rgba(255,255,255,0.2)'}},
          ...
          e('svg',{
            style:{
              position:'absolute',
              top:keeperDir==='left'?30:keeperDir==='right'?30:35,
              left:keeperDir==='left'?'16%':keeperDir==='right'?'52%':'37%',
              width:52,height:75,
            ...
            viewBox:'0 0 52 75',xmlns:'http://www.w3.org/2000/svg'
          },
            // Jersey Colombia yellow
            e('rect',{x:12,y:36,width:24,height:22,rx:4,fill:'#FCD116',stroke:'#c8a000',strokeWidth:1.5}),
            e('rect',{x:12,y:42,width:24,height:5,fill:'#CE1126'}),
            e('rect',{x:12,y:47,width:24,height:4,fill:'#003087'}),
            e('text',{x:24,y:45,textAnchor:'middle',fontSize:4,fontWeight:'bold',fill:'white'},'EL LOCO'),

            // Neck
            e('rect',{x:20,y:28,width:9,height:10,rx:2,fill:'#C68642'}),

            // HEAD - positioned lower so not touching crossbar
            e('ellipse',{cx:24,cy:20,rx:10,ry:11,fill:'#C68642',stroke:'#a0522d',strokeWidth:1}),

            // CURLY HAIR - long but starting at head level, not above SVG
            // Top hair
            e('ellipse',{cx:24,cy:11,rx:10,ry:6,fill:'#0d0500'}),
            // Left long curl flowing down
            e('path',{d:'M14 14 C8 18 7 25 10 32 C12 37 11 42 9 46',stroke:'#0d0500',strokeWidth:5,fill:'none',strokeLinecap:'round'}),
            e('path',{d:'M12 13 C6 17 5 24 8 31',stroke:'#0d0500',strokeWidth:4,fill:'none',strokeLinecap:'round'}),
            // Right long curl flowing down
            e('path',{d:'M34 14 C40 18 41 25 38 32 C36 37 37 42 39 46',stroke:'#0d0500',strokeWidth:5,fill:'none',strokeLinecap:'round'}),
            e('path',{d:'M36 13 C42 17 43 24 40 31',stroke:'#0d0500',strokeWidth:4,fill:'none',strokeLinecap:'round'}),
            // Top curls
            e('circle',{cx:18,cy:8,r:3,fill:'#0d0500'}),
            e('circle',{cx:24,cy:6,r:3.5,fill:'#0d0500'}),
            e('circle',{cx:30,cy:8,r:3,fill:'#0d0500'}),

            // EYES
            e('ellipse',{cx:19,cy:19,rx:2.2,ry:1.8,fill:'white'}),
            e('ellipse',{cx:29,cy:19,rx:2.2,ry:1.8,fill:'white'}),
            e('circle',{cx:19,cy:19,r:1.3,fill:'#2a1500'}),
            e('circle',{cx:29,cy:19,r:1.3,fill:'#2a1500'}),
            e('circle',{cx:19.6,cy:18.4,r:0.5,fill:'white'}),
            e('circle',{cx:29.6,cy:18.4,r:0.5,fill:'white'}),

            // EYEBROWS
            e('path',{d:'M16 15 Q19 14 22 15',stroke:'#0d0500',strokeWidth:1.8,fill:'none',strokeLinecap:'round'}),
            e('path',{d:'M26 15 Q29 14 32 15',stroke:'#0d0500',strokeWidth:1.8,fill:'none',strokeLinecap:'round'}),

            // BIG MOUSTACHE
            e('path',{d:'M15 24 Q19 21 24 23 Q29 21 33 24 Q30 28 24 27 Q18 28 15 24',fill:'#0d0500'}),
            // Beard
            e('path',{d:'M16 28 Q20 31 24 30 Q28 31 32 28',stroke:'#0d0500',strokeWidth:1.2,fill:'none',strokeLinecap:'round'}),

            // ARMS
            keeperDir==='left'&&!shotResult
              ?e('path',{d:'M12 40 L-3 26',stroke:'#FCD116',strokeWidth:7,strokeLinecap:'round'})
              :!shotResult&&e('path',{d:'M12 44 L5 56',stroke:'#FCD116',strokeWidth:6,strokeLinecap:'round'}),
            keeperDir==='right'&&!shotResult
              ?e('path',{d:'M36 40 L51 26',stroke:'#FCD116',strokeWidth:7,strokeLinecap:'round'})
              :!shotResult&&e('path',{d:'M36 44 L43 56',stroke:'#FCD116',strokeWidth:6,strokeLinecap:'round'}),

            // Arms during scorpion - forward/down
            shotResult==='saved'&&e('path',{d:'M12 42 L-2 54',stroke:'#FCD116',strokeWidth:7,strokeLinecap:'round'}),
            shotResult==='saved'&&e('path',{d:'M36 42 L50 54',stroke:'#FCD116',strokeWidth:7,strokeLinecap:'round'}),

            // GLOVES
            !shotResult&&keeperDir==='left'&&e('circle',{cx:-3,cy:25,r:5.5,fill:'#FF6B00',stroke:'#cc4400',strokeWidth:1.5}),
            !shotResult&&keeperDir==='left'&&e('circle',{cx:5,cy:56,r:5,fill:'#FF6B00',stroke:'#cc4400',strokeWidth:1.5}),
            !shotResult&&keeperDir==='right'&&e('circle',{cx:51,cy:25,r:5.5,fill:'#FF6B00',stroke:'#cc4400',strokeWidth:1.5}),
            !shotResult&&keeperDir==='right'&&e('circle',{cx:43,cy:56,r:5,fill:'#FF6B00',stroke:'#cc4400',strokeWidth:1.5}),
            shotResult==='saved'&&e('circle',{cx:-2,cy:54,r:5.5,fill:'#FF6B00',stroke:'#cc4400',strokeWidth:1.5}),
            shotResult==='saved'&&e('circle',{cx:50,cy:54,r:5.5,fill:'#FF6B00',stroke:'#cc4400',strokeWidth:1.5}),

            // NORMAL LEGS - standing on ground
            !shotResult&&e('rect',{x:14,y:57,width:9,height:13,rx:2,fill:'#FCD116',stroke:'#c8a000',strokeWidth:1}),
            !shotResult&&e('rect',{x:29,y:57,width:9,height:13,rx:2,fill:'#FCD116',stroke:'#c8a000',strokeWidth:1}),
            !shotResult&&e('ellipse',{cx:18,cy:71,rx:7,ry:3.5,fill:'#111'}),
            !shotResult&&e('ellipse',{cx:33,cy:71,rx:7,ry:3.5,fill:'#111'}),

            // REAL SCORPION KICK
            // Body leans forward (handled by SVG rotation)
            // Left leg curves back and UP over the body
            shotResult==='saved'&&e('path',{
              d:'M17 58 C12 54 6 46 8 36 C10 28 18 22 22 16',
              stroke:'#FCD116',strokeWidth:7,strokeLinecap:'round',fill:'none'
            }),
            // Right leg curves back and UP over the body
            shotResult==='saved'&&e('path',{
              d:'M35 58 C40 54 46 46 44 36 C42 28 34 22 30 16',
              stroke:'#FCD116',strokeWidth:7,strokeLinecap:'round',fill:'none'
            }),
            // Boots at top - behind head
            shotResult==='saved'&&e('ellipse',{cx:22,cy:14,rx:7,ry:3,fill:'#111',stroke:'#333',strokeWidth:1,transform:'rotate(-20 22 14)'}),
            shotResult==='saved'&&e('ellipse',{cx:30,cy:14,rx:7,ry:3,fill:'#111',stroke:'#333',strokeWidth:1,transform:'rotate(20 30 14)'}),
            // Scorpion emoji
            shotResult==='saved'&&e('text',{x:24,y:8,textAnchor:'middle',fontSize:11},'🦂')
          )
          ),
          // Ball
